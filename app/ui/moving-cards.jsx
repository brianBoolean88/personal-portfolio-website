  ...
  return (
    <div
      ...
      <ul
        ...
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-200 bg-[#83967b] px-8 py-6 md:w-[450px] dark:border-zinc-700"
            key={item.name}>
            <blockquote>
              <div
                aria-hidden="true"
              ...
              <span
                className="relative z-20 text-sm leading-[1.6] font-bold text-xl text-neutral-800 dark:text-gray-100">
                {item.quote}
              </span>
              ...
              <div className="flex flex-row">
                <Image
                  ...
                  width={35}
                  height={25}
                  className="mb-1 object-cover rounded-full mr-2"
                />
                <a
                  href={item.href}
